...
package com.iframe.component.refreshlist.swiper;
...
//		final Resources res = getResources();
        setColorSchemeColors(colorRes1, colorRes2, colorRes3, colorRes4);
    }

    private void setColorSchemeResourcesBottom(int colorRes1, int colorRes2, int colorRes3, int colorRes4) {
//		final Resources res = getResources();
        setColorSchemeColorsBottom(colorRes1, colorRes2, colorRes3, colorRes4);
